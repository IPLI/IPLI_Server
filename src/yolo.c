...
void run_yolo(int argc, char **argv, objcnt *objects, FILE *file_pointer, network r_net)
{
    ...
    if(0==strcmp(argv[2], "test")) test_yolo(cfg, weights, filename, thresh);
		...
		prefix, out_filename, mjpeg_port, json_port, dont_show, ext_output, 0, objects, file_pointer, r_net);
}
